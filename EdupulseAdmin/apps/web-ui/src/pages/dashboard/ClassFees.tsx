  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-xl font-bold text-text dark:text-text-dark">Fee Collection Console</h2>
          <p className="text-sm text-textSecondary dark:text-gray-400">Term 1 Academic Year 2025-26</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-neutral-800 p-6 rounded-[2rem] border border-border dark:border-border-dark shadow-sm">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="font-black text-text dark:text-text-dark">Transaction Records</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-danger/5 border border-danger/10 rounded-[2rem] p-6 space-y-4">
            {defaulters.map((def) => (
