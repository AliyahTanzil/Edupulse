...
const ClassSelection: React.FC = () => {
  ...
  return (
    <div className="dashboard-wrapper animate-in fade-in duration-500 dashboard-container">
      <div className="section">
        ...
        <div className="dashboard-card !p-4 !mb-10 flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            <button className="button-primary !bg-gray-50 dark:!bg-neutral-800 !text-text dark:!text-white hover:!bg-gray-100">
              <Filter size={18} />
              <span>Filter</span>
            </button>
